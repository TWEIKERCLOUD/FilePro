...
##   $ docker build -t php-for-tweikercloud-filepro .
##
## RUNNING
##   $ docker run -p 9000:9000 php-for-tweikercloud-filepro
##
## CONNECTING
...
ENV STACKSMITH_STACK_ID="q57ylbm" \
    STACKSMITH_STACK_NAME="PHP for TWEIKERCLOUD/FilePro" \
